            ...
            <div className="carousel">
              <div className="viewport">
                <div className="track pos">
                  <div className="card">
                    <img src="public/images/JAVA.webp" loading="lazy" decoding="async" alt="JAVA" className="tech-icon"   />
                    <div className="bar-container"><div className="bars" id="java"><span className="percs">80%</span></div></div>
                  </div>
                  <div className="card">
                    <img src="public/images/htmlcssjs.webp" loading="lazy" decoding="async" alt="HTML CSS JS" className="tech-icon"   />
                    <div className="bar-container"><div className="bars" id="webtech"><span className="percs">85%</span></div></div>
                  </div>
                  <div className="card">
                    <img src="public/images/Python.webp" loading="lazy" decoding="async" alt="Python" className="tech-icon"   />
                    <div className="bar-container"><div className="bars" id="python"><span className="percs">55%</span></div></div>
                  </div>
                  <div className="card">
                    <img src="public/images/php.webp" loading="lazy" decoding="async" alt="PHP" className="tech-icon"   />
            ...
            <div className="carousel">
              <div className="viewport">
                <div className="track neg">
                  <div className="card">
                    <img src="public/images/React.webp" loading="lazy" decoding="async" alt="ReactJs" className="tech-icon"   />
                    <div className="bar-container"><div className="bars" id="react"><span className="percs">65%</span></div></div>
                  </div>
                  <div className="card">
                    <img src="public/images/bootstrap.webp" loading="lazy" decoding="async" alt="Bootstrap" className="tech-icon"   />
                    <div className="bar-container"><div className="bars" id="bootstrap"><span className="percs">78%</span></div></div>
                  </div>
                  <div className="card">
                    <img src="public/images/telwind.webp" loading="lazy" decoding="async" alt="Telwind CSS" className="tech-icon"   />
          ...
          <div className="tech-col" data-col="2">
            ...
            <div className="carousel">
              <div className="viewport">
                <div className="track pos">
                  <div className="card">
                    <img src="public/images/sql.webp" loading="lazy" decoding="async" alt="SQL" className="tech-icon"   />
                    <div className="bar-container"><div className="bars" id="sql"><span className="percs">90%</span></div></div>
                  </div>
                  <div className="card">
                    <img src="public/images/mysql.webp" loading="lazy" decoding="async" alt="MySQL" className="tech-icon"   />
                    <div className="bar-container"><div className="bars" id="mysql"><span className="percs">72%</span></div></div>
                  </div>
                  <div className="card">
                    <img src="public/images/firebase.webp" loading="lazy" decoding="async" alt="Firebase" className="tech-icon"   />
          ...
          <div className="tech-col" data-col="3">
            ...
            <div className="carousel">
              <div className="viewport">
                <div className="track neg">
                  <div className="card">
                    <img src="public/images/github.webp" loading="lazy" decoding="async" alt="GitHub" className="tech-icon"   />
                    <div className="bar-container"><div className="bars" id="github"><span className="percs">58%</span></div></div>
                  </div>
                  <div className="card">
                    <img src="public/images/netlify.webp" loading="lazy" decoding="async" alt="Netlify" className="tech-icon"   />
                    <div className="bar-container"><div className="bars" id="netlify"><span className="percs">74%</span></div></div>
                  </div>
                  <div className="card">
                    <img src="public/images/vscode.webp" loading="lazy" decoding="async" alt="VS Code" className="tech-icon"   />
                    <div className="bar-container"><div className="bars" id="vscode"><span className="percs">89%</span></div></div>
                  </div>
                  <div className="card">
                    <img src="public/images/figma.webp" loading="lazy" decoding="async" alt="Figma" className="tech-icon"   />
                    <div className="bar-container"><div className="bars" id="figma"><span className="percs">81%</span></div></div>
                  </div>
                  <div className="card">
                    <img src="public/images/canva.webp" loading="lazy" decoding="async" alt="Canva" className="tech-icon"   />
